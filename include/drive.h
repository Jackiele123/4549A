...
void position_drive2(float starting_point_x, float starting_point_y, float ending_point_x, float ending_point_y, float max_speed, float max_error, float timeout, float look_ahead_distance = 30, int early_stop = 0, int startpower = 0, float end_speed = 90);

void driveInches(float starting_point_x, float starting_point_y, float inchesToTravel, float max_speed, float max_error, float timeout, float look_ahead_distance = 30, int early_stop = 0, int startpower = 0, float end_speed = 90);
